...
import plugin.safe.cloud.seal.fragment.ShowSealInfoStep1Fragment;
import plugin.safe.cloud.seal.fragment.ShowSealInfoStep2Fragment;
...
public class ShowSealInfoActivity extends BaseActivity {
...
//		getUserInfo();
	...
	private void initView(){
		...
		if (mShowInfoFragment == null){
			mShowInfoFragment = new ShowSealInfoStep1Fragment(that);
			Bundle bundle = new Bundle();
            bundle.putString("sealNo", mSealNo); 
			mShowInfoFragment.setArguments(bundle);
			...
			mShowInfoFragment.setFragmentActionListener(new ActionOperationInterface() {
				...
				public void onNextFragment(String signId, String signType) {
					...
					if (mShowInfoFragment2 == null){
						...
						mShowInfoFragment2 = new ShowSealInfoStep2Fragment(that);
						Bundle bundle = new Bundle();
			            bundle.putString("sealNo", mSealNo); 
			...
			fragmentTransaction.show(mShowInfoFragment);
			fragmentTransaction.commitAllowingStateLoss();
		}
