...
package plugin.safe.cloud.seal.download;
...
public final class Downloads implements BaseColumns {
     ...
     */
    public static final String AUTHORITY = "plugin.safe.cloud.seal.download";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS = "plugin.safe.cloud.seal.download.permission.ACCESS_DOWNLOAD_MANAGER";
     ...
     * @hide
     */
    public static final String PERMISSION_ACCESS_ADVANCED = "plugin.safe.cloud.seal.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED";

    /**
     * The permission to access the all the downloads in the manager.
     */
    public static final String PERMISSION_ACCESS_ALL = "plugin.safe.cloud.seal.download.permission.ACCESS_ALL_DOWNLOADS";
     ...
     * @hide
     */
    public static final String PERMISSION_SEND_INTENTS = "plugin.safe.cloud.seal.download.permission.SEND_DOWNLOAD_COMPLETED_INTENTS";

    /**
     * The permission to download files without any system notification being
     * shown.
     */
    public static final String PERMISSION_NO_NOTIFICATION = "plugin.safe.cloud.seal.download.permission.DOWNLOAD_WITHOUT_NOTIFICATION";
     ...
     * plugin.safe.cloud.seal.download.permission.ACCESS_DOWNLOAD_MANAGER_ADVANCED.
     * <P>
     * Type: INTEGER
     * </P>
     * <P>
