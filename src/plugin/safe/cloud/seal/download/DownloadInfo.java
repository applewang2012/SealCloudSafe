...
public class DownloadInfo {
    ...
    public void sendIntentIfRequested() {
        ...
        Intent intent;
        if (mIsPublicApi) {
            intent = new Intent(SealDownloadManager.ACTION_DOWNLOAD_COMPLETE);
            intent.setPackage(mPackage);
            intent.putExtra(SealDownloadManager.EXTRA_DOWNLOAD_ID, mId);
    ...
    private int translateNetworkTypeToApiFlag(int networkType) {
        switch (networkType) {
            case ConnectivityManager.TYPE_MOBILE:
                return SealDownloadManager.Request.NETWORK_MOBILE;

            case ConnectivityManager.TYPE_WIFI:
                return SealDownloadManager.Request.NETWORK_WIFI;
