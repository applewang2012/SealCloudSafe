...
public class AddSealInfoStep1Fragment extends BaseFragment implements DataStatusInterface{
	...
	private EditText mSealNeirongText;
	...
	public AddSealInfoStep1Fragment(Context ctx) {
		mContext = ctx;
	}
...
//		});
		...
		mSealNeirongText = (EditText) mRootView.findViewById(R.id.id_aty_apply_seal_seal_neirong_content);
...
//				checkPhoneVerifyCode(mPhone, mVerifyCode);
	...
	private void requestUpdateSignInfo(String signId){
		...
		rpc.addProperty("regDeptId",mSelectorInfo.get("getAllRegister").getSelectedId());
		rpc.addProperty("content",mSealNeirongText.getText().toString());
	...
	private void requestDefaultSignetContent(){
		if (mSelectorInfo.get("GetCorporationInfo") != null && mSelectorInfo.get("GetCorporationInfo").getSelectedId() != null){
			if (mSelectorInfo.get("GetGeneralCode"+TYPE_ST)!= null && mSelectorInfo.get("GetGeneralCode"+TYPE_ST).getSelectedId() != null){
				...
				Log.w("mingguo", "default content  signet type id  "+mSelectorInfo.get("GetGeneralCode"+TYPE_ST).getSelectedId()+"  type  "+mSelectorInfo.get("GetGeneralCode"+TYPE_ST).getSelectedName());
