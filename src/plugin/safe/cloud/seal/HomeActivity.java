...
public class HomeActivity extends BaseActivity implements DataStatusInterface{
	...
	private void initView(){
		...
		addSealButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startPluginActivity(new DLIntent("plugin.safe.cloud.seal", "plugin.safe.cloud.seal.ApplyForSealActivity"));
